...
> **[ARCHIVED]**: This guide references Supabase deployment values used during migration.
> The live frontend now uses Firebase. These values are preserved for historical
> reference only and should not be treated as current deployment targets.
